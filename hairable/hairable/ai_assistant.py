    ...
    def post(self, request):
        ...
        try:
            ...
            for store in user_stores:
                store_details = {
                    "name": store.name,
                    "services": [service.name for service in Service.objects.filter(store=store)],
                    "staff": [
                        {
                        ...
                        for staff in StoreStaff.objects.filter(store=store)
                    ],
                    "inventory": [
                        {
                            "name": inventory.name,
                        ...
                        for inventory in InventoryItem.objects.filter(store=store)
                    ]
                }
